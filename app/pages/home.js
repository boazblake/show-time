import { BoazFace } from "components"

export const Home = () => {
  return {
    view: () =>
      m(".page", [
        m("section.pic", m(BoazFace)),
        m("br"),
        m(
          ".row",
          m("section.intro", [
            m(
              "code.intro-text",
              "I am a Front-End web developer with 3 + years industry experience  building a variety of different applications and using a multitude of different frameworks and languages. "
            ),
            m("br"),
