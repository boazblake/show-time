...
var Hamburger = function Hamburger() {
  ...
  return {
    ...
    view: function view(_ref3) {
      ...
      }, mdl.Sidebar.isShowing() ? m(_cjs.CloseLine) : [mdl.Invites.needRSVP().length && [m(".notif-count", mdl.Invites.needRSVP().length), m(_cjs.BellLine)], m(_cjs.BarsLine)])];
    }
  };
};
  ...
  return {
    view: function view(_ref) {
      ...
      return m(".sidebar-page", [m(".sidebar-tab-section", m(".frow row ", [m("button.sidebar-tab.col-xs-1-3", {
        ...
        class: "col-xs-1-3"
      }, "Logout"))])), state.Invites.isShowing() && m(".sidebar-section", [m(".frow column-center height-100", [m(".sidebar-article frow height-100", [mdl.Invites.needRSVP().map(function (invite, idx) {
...
var toEventviewModel = function toEventviewModel(mdl) {
  return function (_ref) {
    ...
    return {
      ...
      startTime: M(start).format((0, _Utils.displayTimeFormat)(mdl)),
      endTime: M(end).format((0, _Utils.displayTimeFormat)(mdl)),
      notes: notes,
      allDay: allDay,
      location: location,
      inPerson: inPerson,
...
var loadEventTask = function loadEventTask(http) {
  return function (mdl) {
    return function (eventId) {
      ...
      }).ap(getEventByIdTask(http)(mdl)(eventId)).ap((0, _Http.getItemsByEventIdTask)(http)(mdl)(eventId)).ap(getEventGuestsByEventIdTask(http)(mdl)(eventId));
    };
  };
};
