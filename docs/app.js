...
var Sidebar = function Sidebar() {
  ...
  return {
    view: function view(_ref) {
      ...
      }, "Profile"), m("button.sidebar-tab.col-xs-1-3", m(m.route.Link, {
        id: "scale-me",
        href: "/logout",
...
var Event = function Event(_ref) {
  ...
  var deleteInvite = function deleteInvite(mdl) {
    ...
    var invite = isLast ? data.guests[0] : data.guests.filter((0, _ramda.propEq)("guestId", mdl.User.objectId))[0];
  ...
  return {
    ...
    view: function view() {
      ...
      return m(".event-page", [state.status == "loading" && m(".", "Fetching Event..."), state.status == "failed" && m(".code", state.error.message), state.status == "success" && m(".width-100", [m(".event-page-heading width-100", [m("h1.event-page-title.text-center", data.event.title), m(".frow row width-100", m("h3.event-page-subheading.col-xs-1-2", "".concat(M(data.event.start).format("ddd MM-DD-YYYY"), " | ")), m("h3.event-page-subheading.col-xs-1-2", "".concat(data.event.startTime, " - ").concat(data.event.endTime)))]), m(".accordian", [m(_Components.AccordianItem, {
        mdl: mdl,
        state: state,
        data: data,
        part: "info",
        ...
        part: "comments",
        title: "Comments"
      }, m(".frow row-start", [m(".frow width-100", [m(".events-messages-container width-100", {
        oncreate: function oncreate(_ref5) {
          var dom = _ref5.dom;
      ...
      }, "Delete"), m("button.btn-".concat((0, _Utils.getTheme)(mdl)), {
        onclick: function onclick(e) {
...
exports.isEqual = exports.range = exports.isSideBarActive = exports.jsonCopy = exports.nameFromRoute = exports.NoOp = exports.Pause = exports.randomPause = exports.rand = exports.hyphenize = exports.getInviteStatusColor = exports.inviteOptions = exports.debounce = exports.stackInvites = exports.getTheme = exports.log = void 0;
