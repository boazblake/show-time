...
;require.register("Components/event-form.js", function(exports, require, module) {
"use strict";
  ...
  return {
    view: function view() {
      return m("form.event-form", [m("label", m("input", {
        ...
        type: "time",
        disabled: data.allDay
      }), "End Time")]]), m(".frow row row-between", [m("label.col-xs-1-5", "In Person", m("input", {
        type: "checkbox",
...
var _eventForm = require("./event-form.js");
