...
var AccordianItem = function AccordianItem() {
  return {
    view: function view(_ref) {
      ...
      return m(".accordian-item.full-width", [m(".accordian-item-title".concat(state[part].show() ? "-open" : "-closed"), [m(".frow", {
        onclick: function onclick(e) {
...
var Navbar = function Navbar() {
  return {
    view: function view(_ref) {
      ...
      }, m("h4", date.clone().subtract(1, "month").format("MMM"))), m(".centerMonthGroup", [m("h2.currentMonth", date.format("MMMM")), m("h3.text-center", date.format("YYYY"))]), m(m.route.Link, {
        selector: "button.btn",
        href: "/".concat((0, _Utils.hyphenize)(mdl.User.name), "/").concat(date.clone().add(1, "month").format("YYYY-MM-DD"))
      }, m("h4", date.clone().add(1, "month").format("MMM")))]), m(".frow width-100 row-between mt-10", [m(m.route.Link, {
        selector: "button.btn",
...
var Hamburger = function Hamburger() {
  var load = function load(_ref) {
    ...
    (0, _Http.getInvitesByUserIdTask)(_Http.HTTP)(mdl)(mdl.User.objectId).fork(onError, onSuccess);
  };
  ...
  return {
    ...
    view: function view(_ref3) {
      ...
      }, mdl.Sidebar.isShowing() ? m(_cjs.CloseLine) : [mdl.Invites.needRSVP().length > 0 && [m(".notif-count", mdl.Invites.needRSVP().length), m(_cjs.BellLine)], m(_cjs.BarsLine)])];
    }
  };
};
  ...
  return {
    view: function view(_ref2) {
      var children = _ref2.children,
          mdl = _ref2.attrs.mdl;
      return m(".lt-grid-container", [m(".lt-header.navbar", m(".frow row", [m(Header, {
        mdl: mdl
...
var Profile = function Profile() {
  ...
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      // console.log(mdl)
      return m(".profile-section", [m("label", "Use 24 Hrs", m("input", {
        type: "checkbox",
...
var Sidebar = function Sidebar() {
  ...
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".sidebar-page", [m(".sidebar-tab-section", m(".frow row ", [m("button.sidebar-tab.col-xs-1-3", {
        class: state.Invites.isShowing() ? "sidebar-tab-selected" : "",
        onclick: function onclick(e) {
          return showState("Invites");
        }
      }, "New Invites"), m("button.sidebar-tab.col-xs-1-3", {
        class: state.Profile.isShowing() ? "sidebar-tab-selected" : "",
        onclick: function onclick(e) {
          return showState("Profile");
        }
      }, "Profile"), m(".required-field", m(m.route.Link, {
        href: "/logout",
...
exports.updateCommentTask = exports.deleteCommentTask = exports.deleteBulkCommentsTask = exports.getCommentsByUserIdTask = exports.getCommentsByEventIdTask = exports.addCommentTask = void 0;
...
var getCommentsByUserIdTask = function getCommentsByUserIdTask(http) {
  return function (mdl) {
    return function (userId) {
      return http.backEnd.getTask(mdl)("data/Comments?pageSize=100&where=userId%3D'".concat(userId, "'&sortBy=created%20asc"));
    };
  };
};

exports.getCommentsByUserIdTask = getCommentsByUserIdTask;

var deleteBulkCommentsTask = function deleteBulkCommentsTask(http) {
  return function (mdl) {
    return function (userId) {
      return http.backEnd.deleteTask(mdl)("data/Comments?where=userId%3D'".concat(userId, "'"));
    };
  };
};
...
exports.submitEventTask = exports.deleteEventTask = exports.loadEventTask = exports.getEventByIdTask = void 0;
...
exports.deleteInviteTask = exports.createInviteTask = exports.sendInviteTask = exports.getInvitesTaskByEventId = exports.getInvitesByUserIdTask = exports.updateInviteTask = exports.toInviteViewModel = void 0;
...
var getInvitesByUserIdTask = function getInvitesByUserIdTask(http) {
  return function (mdl) {
    return function (userId) {
      return http.backEnd.getTask(mdl)("data/Invites?pageSize=100&where=userId%3D'".concat(userId, "'&sortBy=start%20asc")).map((0, _ramda.map)(toInviteViewModel));
    };
  };
};

exports.getInvitesByUserIdTask = getInvitesByUserIdTask;
...
exports.updateItemTask = exports.deleteItemTask = exports.deleteBulkItemsTask = exports.getItemsByUserIdTask = exports.getItemsByEventIdTask = exports.addItemTask = void 0;
...
var addItemTask = function addItemTask(http) {
  return function (mdl) {
    return function (item) {
      return http.backEnd.postTask(mdl)("data/Items")(item).chain(function (_ref) {
        var objectId = _ref.objectId;
        var itemId = objectId;
        return _data.default.of(function (user) {
          return function (event) {
...
var getItemsByUserIdTask = function getItemsByUserIdTask(http) {
  return function (mdl) {
    return function (userId) {
      return http.backEnd.getTask(mdl)("data/Items?pageSize=100&where=userId%3D'".concat(userId, "'&sortBy=name%20asc"));
    };
  };
};

exports.getItemsByUserIdTask = getItemsByUserIdTask;

var deleteBulkItemsTask = function deleteBulkItemsTask(http) {
  return function (mdl) {
    return function (userId) {
      return http.backEnd.deleteTask(mdl)("data/Items?where=userId%3D'".concat(userId, "'&sortBy=name%20asc"));
    };
  };
};
...
var isUserOrUnclaimed = function isUserOrUnclaimed(mdl) {
  return function (item) {
    return [mdl.User.objectId, null].includes(item.userId);
  };
};
...
var Event = function Event(_ref) {
  ...
  var load = function load(_ref3) {
    ...
    (0, _Http.loadEventTask)(_Http.HTTP)(mdl)(mdl.Events.currentEventId()).fork(onError, updateEvent);
  };
  ...
  var deleteInvite = function deleteInvite(mdl) {
    ...
    var isLast = !(data.guests.length - 1);
    var invite = isLast ? data.guests[0] : data.guests.filter((0, _ramda.propEq)("userId", mdl.User.objectId))[0];

    if (isLast) {
      (0, _ramda.pluck)("objectId", data.items).traverse((0, _Http.deleteItemTask)(_Http.HTTP)(mdl), _data.default.of).chain(function () {
        return (0, _Http.deleteEventTask)(_Http.HTTP)(mdl)(invite.eventId);
      }).fork(onError, onSuccess);
    } else {
      data.items.filter((0, _ramda.propEq)("userId", mdl.User.objectId)).map((0, _ramda.set)((0, _ramda.lensProp)("userId"), null)).traverse((0, _Http.updateItemTask)(_Http.HTTP)(mdl), _data.default.of).chain(function () {
  ...
  var updateInvite = function updateInvite(mdl) {
    return function (update) {
      ...
      (0, _Http.updateInviteTask)(_Http.HTTP)(mdl)(update).chain(function (_) {
  ...
  var addItem = function addItem(mdl) {
    ...
    state.items.isSubmitted(true);
    (0, _validations.validateItemTask)(item)(data).chain((0, _Http.addItemTask)(_Http.HTTP)(mdl)).chain(function (_) {
      return (0, _Http.loadEventTask)(_Http.HTTP)(mdl)(mdl.Events.currentEventId());
    }).fork(onError, onSuccess);
  };
  ...
  return {
    ...
    view: function view() {
      return m(".event-page", [state.status == "loading" && m(".", "Fetching Event..."), state.status == "failed" && m(".code", state.error.message), state.status == "success" && m(".centered-column", [m("h1.", data.event.title), m("h3", "".concat(data.event.date, " | ").concat(data.event.startTime, " - ").concat(data.event.endTime)), m(".accordian", [m(_Components.AccordianItem, {
        ...
        return m(".event-items-item frow ", [m(".col-xs-2-3 ", m("h4", item.name), m("label", item.userId ? [m("span.clickable.frow row-start", isUserOrUnclaimed(mdl)(item) && m(_cjs.MinusCircleLine, {
          onclick: function onclick(e) {
            item.userId = null;
            updateItem(mdl)(item);
          },
        ...
        part: "comments",
        title: "Comments"
      }, m(".frow row-start", [m(".frow width-100", [m(".events-messages-container width-100", data.comments.any() ? data.comments.map(function (comment) {
        return m(".frow column-center width-100 mb-40", m(".event-comments-message-container ".concat(mdl.User.objectId == comment.userId ? "me" : "other"), m(".event-comments-message frow items-end", [m(".speech-bubble", [m("span.text-left", comment.message), mdl.User.objectId == comment.userId && m(_cjs.TimesCircleLine, {
          onclick: function onclick(e) {
            return deleteComment(mdl)(comment.objectId);
          },
          class: "event-comments-message-remove smaller"
        })]), m("label.event-comment-name", m(".frow row-between", [m("span", comment.sender), m("span", M(comment.created).format((0, _Utils.getTimeFormat)(mdl)))]))])));
      }) : m("", "Start a conversation")), m(".event-comment-textbox-container", m(".frow items-end", [m(".col-xs-4-5", m("textarea.comments-message-container", {
        row: 20,
        cols: 50,
        placeholder: "Say hi...",
      ...
      })), m(".col-xs-1-5", m("button.button-none.comments-message-btn", {
        onclick: function onclick(e) {
...
var Home = function Home() {
  return {
    view: function view(_ref) {
      ...
      }), m(".frow.max-width", [m("".concat(mdl.Events.createNewEvent() ? ".col-xs-1-1" : ".col-xs-2-3"), m("button.btn.max-width.height-100", {
        onclick: function onclick(e) {
          return mdl.Events.createNewEvent(!mdl.Events.createNewEvent());
        }
      }, mdl.Events.createNewEvent() ? "Cancel" : "Create New Event")), !mdl.Events.createNewEvent() && m("col-xs-1-3", m("button.btn.max-width.height-100", {
        onclick: function onclick(e) {
...
var getMyLocationTask = function getMyLocationTask(mdl) {
  ...
  }).map((0, _ramda.prop)("coords")).map((0, _ramda.props)(["latitude", "longitude"])).map(function (coords) {
