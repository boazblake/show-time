...
var Header = {
  view: function view(_ref) {
    var mdl = _ref.attrs.mdl;
    return m("#header", [m("code", m("p.typewriter type-writer", {
      id: "logo-header",
    ...
    }, "{Boaz Blake}")), mdl.settings.profile === "desktop" ? m(".navbar", {
      oncreate: (0, _animations.AnimateNavBar)(["slideInDown", _Utils.NoPause, _Utils.randomPause])
  ...
  return {
    view: function view(_ref) {
      ...
      return m(".app", [m(_components.Header, {
        ...
        oncreate: (0, _animations.animateCSS)(["slideInRight", _Utils.NoPause]),
        onbeforeremove: (0, _animations.animateCSS)(["slideOutRight", _Utils.NoPause]),
        mdl: mdl
      })]);
    }
  };
...
var SideBar = function SideBar() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m("ul.sidebar", {
        oncreate: (0, _animations.AnimateSideBarIn)(["slideInLeft", _Utils.NoPause, _Utils.randomPause]),
        onbeforeremove: (0, _animations.AnimateSideBarOut)(["slideOutLeft", (0, _Utils.Pause)(2), (0, _Utils.Pause)(1)])
      }, mdl.routes.filter(function (r) {
        return r !== m.route.get();
      }).map(function (route) {
        return m(m.route.Link, {
...
var Home = {
  view: function view() {
    return m(".page", {
      oncreate: (0, _animations.animateChildrenIn)(["fadeInUp", (0, _Utils.Pause)(1), (0, _Utils.Pause)(1)])
    }, [m("img#boazface", {
  ...
  return {
    ...
    view: function view() {
      return state.status == "loading" && "Repo Loading...", state.status == "failed" && "Error", state.status == "loaded" && m(".repo", {
        oncreate: (0, _animations.animateChildrenIn)(["fadeIn", _Utils.randomPause, _Utils.randomPause])
...
var Portfolio = function Portfolio() {
  ...
  return {
    ...
    view: function view(_ref4) {
      ...
      return m(".page portfolio", m(".repos", state.status == "failed" && "Error fetching Repos ...", state.status == "loading" && "Loading Repos ...", state.status == "loaded" && state.repos.map(function (url) {
        return m(Repo, {
          url: url,
          mdl: mdl
        });
    ...
    "/home": {
      ...
      render: function render() {
        return m(_components.Layout, {
          ...
          oncreate: (0, _animations.animatePageCSS)(["slideInLeft", (0, _Utils.Pause)(1)]),
          onscroll: function onscroll(e) {
            return console.log(e);
          },
          onbeforeremove: (0, _animations.animatePageCSS)(["slideOutRight", (0, _Utils.Pause)(1)]),
          mdl: mdl
        }));
      }
    },
...
function animate(element, stylz) {
  ...
  return transitionEndPromise(element).then(function (_) {
