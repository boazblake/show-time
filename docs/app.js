  ...
  return {
    view: function view(_ref) {
      ...
      return m(".sidebar-rsvp mb-50", [mdl.Invites.needRSVP().length ? mdl.Invites.needRSVP().map(function (invite) {
        return m(".sidebar-invites-".concat((0, _Utils.getTheme)(mdl)), {
          onclick: function onclick(e) {
            return navToInvite(mdl)(invite);
          }
        }, m(".frow mb-10", [m(".col-xs-1-2 text-ellipsis", "".concat(invite.title)), m(".col-xs-1-2", "On: ".concat(invite.start.format("MM-DD-YYYY"))), m(".col-xs-1-2", "From: ".concat(invite.start.format((0, _Utils.getTimeFormat)(mdl)))), m(".col-xs-1-2", "To: ".concat(invite.end.format((0, _Utils.getTimeFormat)(mdl))))]), m(_Components.InviteRSVP, {
          mdl: mdl,
          guest: invite
        }));
      }) : m(_Components.EmptyState, {
