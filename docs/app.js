...
var Sidebar = function Sidebar() {
  ...
  var toItemViewModel = (0, _ramda.reduce)(function (acc, _ref) {
    var name = _ref.name,
        quantity = _ref.quantity;

    var addNew = function addNew(n, q) {
      return acc.push({
        name: n,
        quantity: q
      });
    ...
    acc.any() ? acc.map(function (i) {
      console.log("i", i.name.toLowerCase() == name.toLowerCase() ? "same" : name);
      i.name.toLowerCase() == name.toLowerCase() ? i.quantity += quantity : addNew(name.toLowerCase(), quantity);
  ...
  return {
    ...
    view: function view(_ref3) {
      ...
      return m(".sidebar-page", [m(".sidebar-tab-section", m(".frow row ", [m("button.sidebar-tab.col-xs-1-3", {
        ...
        class: "col-xs-1-3"
      }, "Logout")])), state.Home.isShowing() && m(".sidebar-section", [m(".frow column-center", [m(".sidebar-article", [m("p.sidebar-section-heading", "Items"), m(".ul", state.Home.data.items.map(function (item) {
        return m("li.sidebar-items-list", item.name + " : " + item.quantity);
...
var getEventGuestsByEventIdTask = function getEventGuestsByEventIdTask(http) {
  return function (mdl) {
    return function (eventId) {
      return (0, _Http.getInvitesTaskByEventId)(http)(mdl)(eventId).chain((0, _ramda.traverse)(_data.default.of, getProfilesTask(http)(mdl)));
    };
  };
};
...
exports.updateItemTask = exports.deleteItemTask = exports.getItemsByUserIdTask = exports.getItemsByEventIdTask = exports.addItemTask = void 0;
